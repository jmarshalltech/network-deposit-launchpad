...
export const BesuDetails = () => (
  <>
    ...
    <section>
        ...
        <>
          ...
          >
            <FormattedMessage
              ...
              description="Link to documentation about Pandora client Besu, specifically for goerli testnet"
            />
          </Link>
        </>
      )}
      ...
      <Text className="mt10">
        <FormattedMessage
          defaultMessage="Use {http} to connect your LYXt node to the JSON RPC
