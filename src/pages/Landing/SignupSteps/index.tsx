      ...
      <StepsContainer>
        <ScrollAnimation animateIn="fadeInUp" animateOnce>
          <Step
            ...
            content={intl.formatMessage({
              defaultMessage:
                'The LYXt upgrades will only be successful if validators understand the risks and responsibilities.',
            })}
          >
        ...
        <ScrollAnimation animateIn="fadeInUp" animateOnce delay={300}>
          <Step
            ...
            content={intl.formatMessage({
              defaultMessage:
                "You'll need to run a LYXt node to become a validator. Take a look at the checklist to prepare yourself and your equipment.",
            })}
          >
